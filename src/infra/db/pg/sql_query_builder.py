...
class SQLQueryBuilder:
    ...
    def insert(self, column: str):
        self.reset()
        self._is_insert = True
        statement = f"insert into {column}"
        self._raw_query = statement
    ...
    def data_type_format(self, value, quote_strings=True):
        if type(value) == str and quote_strings:
            return f"'{value}'"
        else:
            return f"{value}"

    def flat_matrix_to_string(self, matrix, quote_strings=False, separator=","):
        matrix_string = ""
